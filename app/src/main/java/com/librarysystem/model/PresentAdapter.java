...
/**
 * Created by g on 2017/3/22.
 */

public class PresentAdapter extends ArrayAdapter<PresentBooks> {
    private int resourceId;
    private Context contextThe;

    public PresentAdapter(Context context, int textViewResourceId, List<PresentBooks> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        PresentBooks books = getItem(position);
        ...
        try {
            ...
            if (days < 1) {
                ...
                view.setBackgroundColor(Color.parseColor("#e2d3a7"));
            }
